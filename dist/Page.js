...
function (_PureComponent) {
  ...
  function PageInternal() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setDimensions", function (h, w) {
      _this.setState({
        height: h,
        width: w
      });
  ...
  (0, _createClass2["default"])(PageInternal, [{
    ...
    value: function renderMainLayer() {
      ...
      var layerShowing = this.props.layerShowing;
    ...
    value: function renderTextLayer() {
      ...
      return _react["default"].createElement(_TextLayer["default"], {
        display: layerShowing === 'textlayer' ? 'inline-block' : 'none',
...
}, (0, _propTypes2.eventsProps)()); // forwardRef render functions do not support propTypes
