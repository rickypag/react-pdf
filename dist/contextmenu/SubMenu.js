...
var SubMenu = function (_AbstractMenu) {
  ...
  _createClass(SubMenu, [{
    ...
    value: function render() {
      ...
      return _react2["default"].createElement('nav', _extends({}, menuProps, {
        role: 'menuitem',
        tabIndex: '-1',
        'aria-haspopup': 'true'
      }), _react2["default"].createElement('div', _extends({}, attributes, menuItemProps), title), _react2["default"].createElement('nav', _extends({}, subMenuProps, {
        role: 'menu',
        tabIndex: '-1'
