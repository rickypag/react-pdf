...
var ignoredTriggerProps = [].concat(_toConsumableArray(Object.keys(_ContextMenuTrigger2["default"].propTypes)), ['children']); // expect the id of the menu to be responsible for as outer parameter